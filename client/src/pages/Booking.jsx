...
export default function Booking() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-slate-800">Resource Booking</h1>
      <p className="mt-1 text-sm text-slate-500">Overlap-safe scheduling — back-to-back slots allowed, true overlaps rejected.</p>
      ...
      {resources.length === 0 ? (
        ...
        <>
          <div className="mt-5 rounded-xl bg-white p-5 ring-1 ring-slate-200">
            ...
            <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              <div className="flex items-end">
                <button onClick={book} className={`${btn} w-full bg-indigo-600 text-white hover:bg-indigo-700`}>Book slot</button>
              </div>
            </div>
          ...
          <div className="mt-6">
            <h2 className="mb-2 font-semibold text-slate-800">Bookings for this resource</h2>
