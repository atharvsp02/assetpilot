    ...
    <div className="min-h-screen grid place-items-center bg-[#efece8] px-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 text-center">
          ...
          <p className="text-sm text-[#847d76]">Enterprise Asset &amp; Resource Management</p>
        </div>
        <form onSubmit={submit} className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-[#e6e3df]">
          <h2 className="mb-4 text-lg font-semibold text-[#37322f]">Sign in</h2>
          {error && (
          ...
          <input
            ...
            required
            className="mb-4 mt-1 w-full rounded-md border border-[#e0dedb] px-3 py-2 text-sm focus:border-[#37322f] focus:outline-none focus:ring-1 focus:ring-[#37322f]"
          />
          <button
            type="submit"
            disabled={loading}
          ...
          <p className="mt-4 text-center text-sm text-[#847d76]">
            No account?{' '}
            <Link to="/signup" className="font-medium text-[#37322f] hover:underline">
              Sign up
            </Link>
          </p>
        </form>
        <p className="mt-4 text-center text-xs text-[#a39c94]">
